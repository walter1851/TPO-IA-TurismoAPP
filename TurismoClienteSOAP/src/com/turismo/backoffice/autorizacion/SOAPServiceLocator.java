...
public class SOAPServiceLocator extends org.apache.axis.client.Service implements com.turismo.backoffice.autorizacion.SOAPService {
    ...
    private java.lang.String SOAPPort_address = "http://localhost:8080/IA_TPO_BO_G05_EJB/SOAP";
    ...
    public com.turismo.backoffice.autorizacion.SOAP getSOAPPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.turismo.backoffice.autorizacion.SOAPServiceSoapBindingStub _stub = new com.turismo.backoffice.autorizacion.SOAPServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.turismo.backoffice.autorizacion.SOAP.class.isAssignableFrom(serviceEndpointInterface)) {
                com.turismo.backoffice.autorizacion.SOAPServiceSoapBindingStub _stub = new com.turismo.backoffice.autorizacion.SOAPServiceSoapBindingStub(new java.net.URL(SOAPPort_address), this);
                _stub.setPortName(getSOAPPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://servicios.backoffice.com/", "SOAPService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://servicios.backoffice.com/", "SOAPPort"));
        }
