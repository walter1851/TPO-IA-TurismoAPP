...
public class ProducerOfertaHoteleraRest {
	...
	public Response buscarOfertaPaquete(@PathParam("idOfertaHotelera") String idOfertaHotelera,
			...
			@PathParam("direccionEstablecimiento") String direccionEstablecimiento, @PathParam("idCiudad") String idCiudad,
			@PathParam("nombreCiudad") String nombreCiudad, @PathParam("idHotel") String idHotel,
